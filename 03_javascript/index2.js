/*
자료형의 종류
    -sting(문자열), number(숫자), boolean, null, underfined
    - object(객체), array(배열)
    */

// 1. string
let myName = 'chulsoon'
let email = 'nicnk90@gmail.com'
console.log(myName)
console.log(email)
...
var name="성춘향" // 재선언 가능
// 재선언 가능한 것이 장점같을 수 있으나
// 협업과 유지보수가 힘들어서 사용을 지양하는 것이 좋다.
...
c = 15
console.log(c)
// let c=123 -> Uncaught SyntaxError, 재선언 불가능

// 3. const - 재할당, 재선언 불가
// const b; -> Uncaught SyntaxError, 선언과 동시에 초기화되어야 한다.
const b = 3
// const b = 5
// b = 5 -> 000Uncaught TypeError, 재할당 불가능
